...
def create_html_table(excel_file):
    """
    Read the Excel file with product data,
    convert the 'Features' column to HTML tables,
    and save the updated data to a new Excel file.
    """
    # Read the Excel file
...
if __name__ == "__main__":
    excel_file = f'extracted_products_{date.today()} - Copy.xlsx'
    create_html_table(excel_file)